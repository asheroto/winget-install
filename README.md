...
-   Compatible with:
    ...
    -   Windows Sandbox
    -   Server Core (non desktop experience) - still under beta testing, see [issue #53](https://github.com/asheroto/winget-install/issues/53) for details
-   Not compatible with:
...
-   If you see an error message when installing, try using the `-AlternateInstallMethod` parameter.
